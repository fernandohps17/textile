    ...
    <div class="content">
        <div class="about">
            ...
            <section class="about_content">
                ...
                <header>
                    <h1 class="about_title">Hacemos que cada tela cuente</h1>
                </header>
                <p class="about_subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor <br> incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud <br> exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>

                <br>
                <div class="about_content_box">
                    <section class="about_content_box_left">
                        <div class="about_content_box_left_image">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                                <path d="M480-320q75 0 127.5-52.5T660-500q0-75-52.5-127.5T480-680q-75 0-127.5 52.5T300-500q0 75 52.5 127.5T480-320Zm0-72q-45 0-76.5-31.5T372-500q0-45 31.5-76.5T480-608q45 0 76.5 31.5T588-500q0 45-31.5 76.5T480-392Zm0 192q-146 0-266-81.5T40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200Zm0-300Zm0 220q113 0 207.5-59.5T832-500q-50-101-144.5-160.5T480-720q-113 0-207.5 59.5T128-500q50 101 144.5 160.5T480-280Z" />
                            </svg>
                        </div>
                        <header class="about_content_box_left_title">
                            <h2>Nuestra Vision</h2>
                        </header>
                        <p class="about_content_box_left_subtitle">Lorem ipsum dolor sit amet,<br> consectetur adipiscing elit,<br> sed do eiusmod tempor <br> incididunt ut labore</p>
                    </section>

                    <section class="about_content_box_rigth">
                        <div class="about_content_box_rigth_image">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                                <path d="m226-559 78 33q14-28 29-54t33-52l-56-11-84 84Zm142 83 114 113q42-16 90-49t90-75q70-70 109.5-155.5T806-800q-72-5-158 34.5T492-656q-42 42-75 90t-49 90Zm178-65q-23-23-23-56.5t23-56.5q23-23 57-23t57 23q23 23 23 56.5T660-541q-23 23-57 23t-57-23Zm19 321 84-84-11-56q-26 18-52 32.5T532-299l33 79Zm313-653q19 121-23.5 235.5T708-419l20 99q4 20-2 39t-20 33L538-80l-84-197-171-171-197-84 167-168q14-14 33.5-20t39.5-2l99 20q104-104 218-147t235-24ZM157-321q35-35 85.5-35.5T328-322q35 35 34.5 85.5T327-151q-25 25-83.5 43T82-76q14-103 32-161.5t43-83.5Zm57 56q-10 10-20 36.5T180-175q27-4 53.5-13.5T270-208q12-12 13-29t-11-29q-12-12-29-11.5T214-265Z" />
                            </svg>
                        </div>
                        <header class="about_content_box_rigth_title">
                            <h2>Nuestra Mision</h2>
                        </header>
                        <p class="about_content_box_rigth_subtitle">Lorem ipsum dolor sit amet,<br> consectetur adipiscing elit,<br> sed do eiusmod tempor <br> incididunt ut labore</p>
                    </section>
                </div>
            </section>
            ...
            <div class="about_image">
                <picture class="picture-defer">
                    ...
                    <img class="image" data-img="/public/img/textile-header-imagen-about-us.jpg" alt="Textile sobre nosotros" title="Textile sobre nosotros" width="100" height="100">
                </picture>

                <div class="about_image_etiqueta">
                    <div class="about_image_etiqueta_icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                    ...
                    <div class="about_image_etiqueta_number">11+</div>
                    <div class="about_image_etiqueta_text">Experiencia</div>
                </div>
            </div>
        </div><br><br><br>
        ...
        <div class="about_bottom bg_about">
            <div class="about_bottom_box">
                ...
                <div class="about_bottom_box_number"><strong>100+</strong></div>
            ...
            <div class="about_bottom_box bg_box">
                ...
                <div class="about_bottom_box_number"><strong>1</strong></div>
            ...
            <div class="about_bottom_box">
                ...
                <div class="about_bottom_box_number"><strong>20+</strong></div>
